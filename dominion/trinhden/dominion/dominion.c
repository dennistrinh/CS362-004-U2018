...
int playSmithy(int currentPlayer, int handPos, struct gameState *state) {
	...
	//Desired Effect: +3 Cards
	//Bug introduced: Draws 4 cards instead
    for (i = 0; i <= 3; i++) {
...
int playAdventurer(int currentPlayer, struct gameState *state) {
	...
	//Desired Effect: Stop after two treasure cards are drawn
	//Bug introduced: Go to three.
...
int playCouncilRoom (int currentPlayer, int handPos, struct gameState *state) {
	...
	//+4 Cards
	//Desired effect: Draw 4 cards
	//Introduced bug: Draws 5 cards.
    for (i = 0; i <= 4; i++) {
	  drawCard(currentPlayer, state);
	}
...
int playMine(int currentPlayer, int handPos, struct gameState *state, int choice1, int choice2) {
	...
	//Desired Effect: The card trashed should be picked from choice 1
	//Introduced Bug: Accidentally trying to trash choice 2.
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case mine:
      return playMine(currentPlayer, handPos, state, choice1, choice2);
    ...
    case cutpurse:
	  return playCutpurse(currentPlayer, handPos, state);
