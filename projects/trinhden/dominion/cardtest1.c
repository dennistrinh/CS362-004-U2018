...
int main() {
  ...
  // Check if the player drew 3 cards (Note: +2 to account for smithy discard)
  printf("\nTest: Player 1 drew three cards\n");
  assertTrue(after.handCount[player1], before.handCount[player1] + 2);

  // Check if the player gains 3 cards from his deck
  printf("\nTest: Player 1 drew three cards from his deck\n");
  assertTrue(after.deckCount[player1], before.deckCount[player1] - 3);
