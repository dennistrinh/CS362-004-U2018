...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
	adventurerFunc(state, currentPlayer, temphand);
      return 0;
    ...
    case feast:
	feastFunc(state, temphand, currentPlayer, choice1);
    ...
    case remodel:
      return remodelFunc(state, choice1, choice2, currentPlayer, handPos);
...
//Function to implement the events of the smithy card
...
//Function to implement the events of the adventurer card
void adventurerFunc(struct gameState *state, int currentPlayer, int temphand[])
{
      int drawntreasure=0;
      int cardDrawn;
      int z = 1;
...
//Function to implement the events of the council room card
...
void feastFunc(struct gameState *state, int temphand[], int currentPlayer, int choice1)
{
      int x;
      int i;
...
int remodelFunc(struct gameState *state, int choice1, int choice2, int currentPlayer, int handPos)
{
       int j;
       int i;
       j = state->hand[currentPlayer][choice1];  //store card we will trash
